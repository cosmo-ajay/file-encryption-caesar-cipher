...
main.title("SIGN LANGUAGGE RECOGNITION AND TRANSLATION TO TEXT & SPEECH ")
main.geometry("900x700")
main.configure(bg="#a6c1ee")  # Darker light blue gradient background
...
def play(playcount, gesture):
    class PlayThread(Thread):
        def __init__(self, playcount, gesture):
            Thread.__init__(self)  # Properly initialize the Thread class
...
def uploadDataset():
    ...
    pathlabel.config(text="Dataset Path: " + filename)
    text.delete('1.0', END)
...
# UI Design
title = Label(main, text="SIGN LANGUAGGE RECOGNITION AND TRANSLATION TO TEXT & SPEECH ", font=("Poppins", 20, "bold"), bg="#a6c1ee", fg="#333")
title.pack(pady=20)

# Output Box
text = Text(main, height=15, width=80, font=("Poppins", 12), bg="white", fg="#333", bd=0, highlightthickness=3, highlightbackground="#9b59b6", highlightcolor="#9b59b6")
text.insert(END, "Output will be displayed here...")
text.pack(pady=20, padx=20)

# Path Label
pathlabel = Label(main, text="", font=("Poppins", 12), bg="#a6c1ee", fg="#333")
pathlabel.pack(pady=10)

# Buttons
button_frame = Frame(main, bg="#a6c1ee")
button_frame.pack(pady=20)

upload_button = Button(button_frame, text="Upload Hand Gesture Dataset", command=uploadDataset, font=("Poppins", 12, "bold"), bg="#800080", fg="white", bd=0, padx=20, pady=10, activebackground="#9370DB", activeforeground="white")
upload_button.pack(pady=10, fill="x")

train_button = Button(button_frame, text="Train CNN with Gesture Images", command=trainCNN, font=("Poppins", 12, "bold"), bg="#800080", fg="white", bd=0, padx=20, pady=10, activebackground="#9370DB", activeforeground="white")
train_button.pack(pady=10, fill="x")

predict_button = Button(button_frame, text="Sign Language Recognition from Webcam", command=webcamPredict, font=("Poppins", 12, "bold"), bg="#800080", fg="white", bd=0, padx=20, pady=10, activebackground="#9370DB", activeforeground="white")
predict_button.pack(pady=10, fill="x")
